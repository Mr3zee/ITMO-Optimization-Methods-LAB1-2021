...
public class IntegerEType extends UncheckedIntegerEType {
    ...
    @Override
    protected Integer calcAdd(Integer addendum) throws OverflowEEException, UnderflowEEException {
        checkAddOverflow(value(), addendum);
        return super.calcAdd(addendum);
    }
